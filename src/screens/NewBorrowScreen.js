      ...
      <View style={styles.formRow}>
        <View style={styles.formSection}>
          <Text style={styles.label}>
            <Ionicons name="person-outline" size={16} color={colors.primary} /> Selecionar Aluno
          </Text>
          <TextInput
          ...
          <ScrollView style={styles.list} nestedScrollEnabled>
            {filteredStudents.map((student) => (
              <TouchableOpacity
                key={student.id}
                style={[styles.listItem, selectedStudent?.id === student.id && styles.listItemActive]}
              ...
              >
                ...
                <View>
                  ...
                  <Text style={styles.itemSub}>{student.registration} — {student.class}</Text>
                </View>
